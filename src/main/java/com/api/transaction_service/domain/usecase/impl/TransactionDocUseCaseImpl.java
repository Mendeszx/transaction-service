...
@Component
public class TransactionDocUseCaseImpl implements TransactionOrchestrator {

    private static final Logger log = LoggerFactory.getLogger(TransactionDocUseCaseImpl.class);
